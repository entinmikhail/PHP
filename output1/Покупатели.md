...
#### Метод<br>
*PATCH /api/v4/customers/mode*<br>  
#### Описание<br>
...
| Параметр | Тип данных | Описание |
|---|---|---|
| with | string | Данный параметр принимает строку, в том числе из нескольких значений, указанных через запятую. Данный метод поддерживает <a href="#with-8f4493ae-d009-4b9a-807b-0e94217fbd03-params">следующие параметры</a>.|
...
```<a name="with-8f4493ae-d009-4b9a-807b-0e94217fbd03-params"></a>
...
| Параметр | Тип данных | Описание |
|---|---|---|
| with | string | Данный параметр принимает строку, в том числе из нескольких значений, указанных через запятую. Данный метод поддерживает <a href="#with-44a2f931-16c2-4277-85b5-22642c067a4f-params">следующие параметры</a>.|
...
```<a name="with-44a2f931-16c2-4277-85b5-22642c067a4f-params"></a>
...
### Список транзакций 
#### Метод<br>
*GET /api/v4/customers/transactions*<br>  
#### Описание<br>
...
#### Метод<br>
*GET /api/v4/customers/transactions/{id}*<br>  
#### Описание<br>
...
#### Метод<br>
*POST /api/v4/customers/{customer_id}/transactions*<br>  
#### Описание<br>
...
### Удаление транзакции 
#### Метод<br>
*DELETE /api/v4/customers/transactions/{id}*<br>  
#### Описание<br>
...
#### Метод<br>
*POST /api/v4/customers/{id}/bonus_points*<br>  
#### Описание<br>
