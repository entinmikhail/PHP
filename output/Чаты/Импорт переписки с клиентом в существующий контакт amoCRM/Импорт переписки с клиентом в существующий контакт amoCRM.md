...
Этот шаг необязателен, только для демонстрации возможности получить привязку по чата к контактам. Подробнее можно ознакомится на <a href='/developers/content/api/contacts#contacts-chat-list'>странице метода</a>
#### Пример запроса
...
```<!-- Generated at Tue, 02 Mar 2021 10:12:04 +0000. amoCRM Documentation Generator -->